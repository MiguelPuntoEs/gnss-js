...
export const CONSTELLATIONS: ConstellationRow[] = [
  ...
  },
  {
    ...
    signals: [
      ...
      ...Array.from({ length: 15 }, (_, i) => i - 7).map(
        (k): SignalDef => ({
          constellation: 'GLO_FDMA',
          label: `L1P k=${k}`,
          centerMHz: FREQ_GLO_L1 + k * DELTA_GLO_L1,
          modulation: 'BPSK',
          params: [5.11],
          halfSpanChips: 5.11,
          color: GLO_P_COLOR,
      ...
      ...Array.from({ length: 15 }, (_, i) => i - 7).map(
        (k): SignalDef => ({
          constellation: 'GLO_FDMA',
          label: `L2P k=${k}`,
          centerMHz: FREQ_GLO_L2 + k * DELTA_GLO_L2,
          modulation: 'BPSK',
          params: [5.11],
          halfSpanChips: 5.11,
          color: GLO_P_COLOR,
  ...
  },
  {
    ...
    signals: [
      // L1OC (up), L1SC (down)
      {
        constellation: 'GLO_CDMA',
        label: 'L1OC',
        centerMHz: FREQ_GLO_L1OC,
        modulation: 'BOCs',
        params: [1, 1],
        halfSpanChips: 20,
        color: GLO_OC_COLOR,
  ...
  },
  {
    ...
    signals: [
      // B1A (up + down, same modulation)
      {
        constellation: 'BDS3',
        label: 'B1A',
        centerMHz: FREQ_BDS_B1A,
        modulation: 'BOCs',
        params: [14, 2],
        halfSpanChips: 20,
        color: BDS3_AUTH_COLOR,
        direction: 'up',
      },
      {
        constellation: 'BDS3',
  ...
  },
  {
    ...
    signals: [
      // L5 SPS (up), RS (down)
      {
        constellation: 'NavIC',
        label: 'L5 SPS',
        centerMHz: FREQ_NAVIC_L5,
        modulation: 'BPSK',
        params: [1],
        halfSpanChips: 20,
        color: NAVIC_SPS_COLOR,
        direction: 'up',
      },
      {
        constellation: 'NavIC',
