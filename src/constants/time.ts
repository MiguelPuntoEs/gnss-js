...
export const START_BDS_TIME: Date = new Date('2006-01-01T00:00:00Z');
export const START_UNIX_TIME: Date = new Date('1970-01-01T00:00:00Z');
export const START_NTP_TIME: Date = new Date('1900-01-01T00:00:00Z');
export const START_GLO_LEAP = new Date('1996-01-01T00:00:00Z');
export const START_MJD2000_TIME: Date = new Date('2000-01-01T00:00:00Z'); // Probably wrong, check!
