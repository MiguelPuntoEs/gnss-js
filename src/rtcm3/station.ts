...
function decodeAntennaDescriptor(
  payload: Uint8Array,
  msgType: number,
  meta: StationMeta
): void {
...
function decodeReceiverAntennaDescriptor(
  payload: Uint8Array,
  meta: StationMeta
): void {
...
function decodeTextString(payload: Uint8Array, meta: StationMeta): void {
  ...
  if (nBytes > 0 && nBytes <= 127) {
    ...
    try {
      meta.description = new TextDecoder('utf-8')
...
export function updateStationMeta(
  meta: StationMeta,
  frame: Rtcm3Frame
): boolean {
  try {
