...
/**
 * Maidenhead grid locator (6 characters) from geodetic coordinates.
 * @param lat Latitude in radians
 * @param lon Longitude in radians
 */
...
/**
 * Geohash encoding from geodetic coordinates.
 * @param lat Latitude in radians
 * @param lon Longitude in radians
 * @param precision Number of characters (default 8)
 */
export function geodeticToGeohash(
  lat: number,
  lon: number,
  precision = 8
): string {
